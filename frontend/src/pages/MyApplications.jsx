                        ...
                        <div key={app._id} className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm">
                            ...
                            <div className="mt-6 space-y-4 pt-6 border-t border-gray-50">
                                <div className="flex flex-wrap gap-4">
                                    <a href={`${import.meta.env.PROD ? 'https://craking-backend.onrender.com' : 'http://localhost:5000'}/${app.resume}`} target="_blank" rel="noreferrer" className="flex items-center gap-2 text-xs font-bold text-indigo-600 hover:text-indigo-800 transition">
